...
export default function BehavioralTestPage() {
  ...
  const handleRedirectToSkillBased = () => {
    router.push("/virtual-interview/skill-based")
  }
    ...
    <div className="container bg-[#EBF2FA] mx-auto px-4 py-8 max-w-5xl">
      ...
      {completedCount === totalCount && (
        <div className="flex justify-center mb-6">
          <Button className="bg-[#4E0684] hover:bg-[#4E0684]/90 rounded-full" onClick={handleRedirectToSkillBased}>
            Continue to Skill-Based Interview
          </Button>
        </div>
      )}
                ...
                <TabsTrigger
                  ...
                  className={`px-4 py-2 rounded-none border-b-2 bg-[#EBF2FA] ${
                    activeTab === "in-progress"
                      ? "border-b-[black] bg-[#EBF2FA] text-black"
                      : " bg-[#EBF2FA] border-transparent"
                  }`}
                >
                  In Progress
                </TabsTrigger>
